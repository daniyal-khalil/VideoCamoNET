...
Original file is located at
    https://colab.research.google.com/drive/1TkYZGr4L-wfj2J72jNCVcrWMAW-_DbNX
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_img_dir', type=str, default='/content/drive/MyDrive/Test12/input/')
    parser.add_argument('--train_gt_dir', type=str, default='/content/drive/MyDrive/Test12/groundtruth/')
    ...
    train_loader = get_loader(opt.train_img_dir, opt.train_gt_dir, batchsize=opt.batchsize, trainsize=opt.trainsize, num_workers=12)
